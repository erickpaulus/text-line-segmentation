...
def parse_menu():
    ...
    parser.add_argument('-db',          default=0 ,  choices=['palm'],  help='Database name')
    ...
    parser.add_argument('-smooth',     default=40, type=int, help='smoothing for projection profile matching')
    parser.add_argument('-s',          default=3, type=int, help='number of image slices for projection profile matching')
    parser.add_argument('-sigma',      default=3, type=int, help='standard deviation for gaussian smoothing')
...
def main(args=None):
    ...
    result_path = basepath.replace("datasets","results")+"-S"+ str(args.s)
...
def timeit(func):
    ...
    def timeit_wrapper(*args, **kwargs):
        ...
        with open("time_calculation.txt", "a+") as myfile:            
